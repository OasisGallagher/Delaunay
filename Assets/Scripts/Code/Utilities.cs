...
namespace Delaunay
{
	...
	public class CreateBorderClusterCommand : IEditCommand
	{
		DelaunayMesh mesh;
		IEnumerable<Vector3> vertices;
		int borderClusterID;

		public CreateBorderClusterCommand(DelaunayMesh mesh, IEnumerable<Vector3> vertices)
		{
			this.mesh = mesh;
		...
		public void PlayForward()
		{
			borderClusterID = mesh.AddBorderCluster(vertices).ID;
		}

		public void PlayReverse()
		{
			Utility.Verify(borderClusterID >= 0);
			mesh.RemoveBorderCluster(borderClusterID);
		}
	}
